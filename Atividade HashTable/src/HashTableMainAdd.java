...
//    Crie um algoritmo em JAVA, implementando uma lista telefônica com uma tabela hash. O algoritmo deverá funcionar em loop com duas opções:
//    Adicionar novo contato, onde você solicitará ao usuário o nome da pessoa e em seguida seu número de telefone. Com essas informações o nome da pessoa será sua chave de tabela e o numero seu valor e deverão ser adicionados na tabela hash.
//    Buscar um contato, onde você solicitará ao usuário o nome da pessoa, e retornará o número de telefone encontrado, caso não encontrado deverá informar ao usuário.
